window.tracNghiem11 = [
 ...
 {
  "id": "1D131TN1",
  "question": "Trong các công thức sau, công thức nào <strong>đúng</strong>?",
  "options": [
 ...
 },
 {
  ...
  "answer": 3,
  "explain": "Ta có \\[\\begin{array}{rcl} &&-1 \\le \\sin x \\le 1,\\ \\forall x \\in \\mathbb{R}\\\\ &\\Leftrightarrow& -5 \\le 5\\sin x \\le 5\\\\ &\\Leftrightarrow& -5 - 1 \\le 5\\sin x - 1 \\le 5 - 1\\\\ &\\Leftrightarrow& -6 \\le y \\le 4. \\end{array}\\] Vậy tập giá trị của hàm số là $[-6;4]$.",
  "_wm": "PkFu6GNaZLw9sAMliZIVsiBzJhHa"
 },
 {
  "id": "1D142TN2",
 ...
 {
  "id": "1D153TN6",
  "question": "Phương trình $\\sin x=\\dfrac{\\sqrt{3}}{2}$ có nghiệm là",
  "options": [
   "$x= \\pm \\dfrac{\\pi}{3}+k 2 \\pi$",
   "$x=\\dfrac{\\pi}{3}+k \\pi$",
   "$\\left[\\begin{array}{l}x=\\dfrac{\\pi}{6}+k \\pi\\\\x=\\dfrac{5 \\pi}{6}+k \\pi\\end{array}\\right.$",
 ...
 {
  "id": "1D212TN6",
  "question": "Cho dãy số $(u_n)$ xác định bởi $\\left\\{\\begin{array}{l}u_1 = -1\\\\u_{n+1} = u_n + 3\\end{array}\\right.$. Ba số hạng đầu tiên của dãy số đó là",
  "options": [
   "$4; 7; 10$",
   "$-1; 3; 7$",
   "$1; 4; 7$",
 ...
 {
  "id": "1D212TN9",
  "question": "Cho dãy số $(u_n)$ với $\\left\\{\\begin{array}{l}u_1=5\\\\u_{n+1}=u_n+n\\end{array}\\right.$. Tìm số hạng thứ $4$ của dãy số đã cho.",
  "options": [
   "$12$",
   "$11$",
   "$16$",
 ...
 },
 {
  ...
  "answer": 2,
  "explain": "Ta có $\\left\\{\\begin{array}{l}u_4=81\\\\u_5=-9\\end{array}\\right.$ nên $q=\\dfrac{u_5}{u_4}=\\dfrac{-9}{81}=-\\dfrac{1}{9}$.",
  "_wm": "PkFu6GNaZLw9sAMliZIVsiBzJhHa"
 },
 {
  "id": "1D234TN1",
 ...
 {
  "id": "1D232TN5",
  "question": "Cho cấp số nhân $\\left(u_n\\right)$ với $u_1=81$ và $u_2=27$. Tìm công bội $q$?",
  "options": [
   "$-\\dfrac{1}{3}$",
   "$\\dfrac{1}{3}$",
   "$3$",
  ...
  "answer": 1,
  "explain": "Ta có công bội $q=\\dfrac{u_2}{u_1}=\\dfrac{27}{81}=\\dfrac{1}{3}$.",
  "_wm": "PkFu6GNaZLw9sAMliZIVsiBzJhHa"
 },
 {
  "id": "1D232TN6",
  "question": "Công bội của cấp số nhân $-2$, $6$, $-18$, $54$, $-162$ bằng",
  "options": [
   "$-\\dfrac{1}{3}$",
   "$3$",
   "$-3$",
  ...
  "answer": 2,
  "explain": "Ta có công bội $q=\\dfrac{u_2}{u_1}=\\dfrac{6}{-2}=-3$.",
  "_wm": "PkFu6GNaZLw9sAMliZIVsiBzJhHa"
 },
 {
  "id": "1D312TN1",
 ...
 },
 {
  ...
  "answer": 1,
  "explain": "$\\lim\\limits_{x \\to 4^-} \\dfrac{x^2 + x}{x - 4}=-\\infty$ vì $\\left\\{\\begin{array}{l}\\lim \\limits_{x \\to 4^-}( x^2+x)=20&gt;0\\\\\\lim \\limits_{x \\to 4^-} (x-4)=0\\\\x\\to 4^-\\Rightarrow x-4&lt;0.\\end{array}\\right.$",
  "_wm": "PkFu6GNaZLw9sAMliZIVsiBzJhHa"
 },
 {
  "id": "1D321TN1",
 ...
 {
  "id": "1D331TN2",
  "question": "Cho hàm số $y=f(x)$, xác định trên tập $\\mathscr{D}$ và liên tục tại điểm $x_o$. Trong các mệnh đề sau, mệnh đề nào đúng?",
  "options": [
   "$x_o \\notin D$",
   "$\\displaystyle\\lim\\limits _{x \\rightarrow x_o}f(x)=+\\infty$",
   "$\\displaystyle\\lim\\limits _{x \\rightarrow x_o}f(x)=f\\left(x_o\\right)$",
   "$\\displaystyle\\lim\\limits _{x \\rightarrow x_o}f(x)=-\\infty$"
  ],
  "answer": 2,
  "explain": "Theo định nghĩa tính liên tục tại một điểm thì $\\displaystyle\\lim\\limits_{x \\rightarrow x_o}f(x)=f\\left(x_o\\right)$",
  "_wm": "PkFu6GNaZLw9sAMliZIVsiBzJhHa"
 },
 {
  "id": "1D514TN1",
  "question": "Điều tra về thu nhập của công nhân xí nghiệp X (đơn vị: nghìn đồng/tháng), người ta ghi được bảng tần số ghép lớp sau đây <img src=\"data/11/1D5/im1D51/1D51_tikz_000.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\"> Hỏi mốt của mẫu số liệu đã cho thuộc nhóm nào?",
  "options": [
   "$[7\\,000;7\\,500)$",
   "$[6\\,000;6\\,500)$",
   "$[6\\,500;7\\,000)$",
 ...
 {
  "id": "1D512TN1",
  "question": "Mẫu số liệu sau cho biết cân nặng của học sinh lớp $11$ trong một lớp <img src=\"data/11/1D5/im1D51/1D51_tikz_001.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\"> Số học sinh của lớp đó là bao nhiêu?",
  "options": [
   "$33$",
   "$37$",
   "$35$",
 ...
 {
  "id": "1D512TN2",
  "question": "Cho bảng khảo sát về tiền điện của một số hộ gia đình: <img src=\"data/11/1D5/im1D51/1D51_tikz_002.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\"> Các nhóm số liệu ở bảng trên có độ dài là bao nhiêu?",
  "options": [
   "$45$",
   "$50$",
   "$48$",
 ...
 {
  "id": "1H411TN4",
  "question": "Một hình chóp có đáy là ngũ giác có số mặt và số cạnh lần lượt là",
  "options": [
   "$5$ mặt, $5$ cạnh",
   "$6$ mặt, $5$ cạnh",
   "$6$ mặt, $10$ cạnh",
 ...
 {
  "id": "1H413TN1",
  "question": "Cho hình chóp $S.ABCD$ với $ABCD$ là hình bình hành. Khi đó giao tuyến của hai mặt phẳng $(SAC)$ và $(SAD)$ là",
  "options": [
   "Đường thẳng $SB$",
   "Đường thẳng $SD$",
   "Đường thẳng $SA$",
 ...
 {
  "id": "1H413TN2",
  "question": "Cho tứ diện $ABCD$. Gọi $M, N$ lần lượt là trung điểm của $AC$, $CD$. Giao tuyến của hai mặt phẳng $(MBD)$ và $(ABN)$ là",
  "options": [
 ...
 {
  "id": "1H422TN2",
  "question": "Cho hình chóp $S.ABCD$ có đáy là hình bình hành. $F$, $G$ lần lượt là trung điểm của $SB$ và $SC$. Hãy chọn khẳng định đúng trong các khẳng định sau?<br><img src=\"data/11/1H4/im1H42/1H42_tikz_001.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\">",
  "options": [
   "$FG \\parallel A D$",
   "$FG$ và $SA$ cắt nhau",
   "$FG$ và $BC$ chéo nhau",
 ...
 },
 {
  ...
  "answer": 0,
  "explain": "<img src=\"data/11/1H4/im1H45/1H45_tikz_001.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\"><br>Theo lý thuyết của hình hộp ta có các mặt của hình hộp là hình bình hành.<br>Suy ra $B'C' \\parallel AD$ (cùng song song $BC$) và $B'C' = AD$ (cùng bằng $BC$).<br>Xét tứ giác $AB'C'D$ có $B'C' \\parallel AD$ và $B'C' = AD$.<br>Suy ra tứ giác $AB'C'D$ là hình bình hành.",
  "_wm": "PkFu6GNaZLw9sAMliZIVsiBzJhHa"
 },
 {
  "id": "1H452TN1",
  "question": "Hình lăng trụ tam giác $ABC.A'B'C'$ có bao nhiêu mặt?",
  "options": [
   "$5$",
   "$4$",
   "$6$",
  ...
  "answer": 0,
  "explain": "<img src=\"data/11/1H4/im1H45/1H45_tikz_002.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\"><br>Ta thấy hình lăng trụ tam giác $ABC.A'B'C'$ có 5 mặt.",
  "_wm": "PkFu6GNaZLw9sAMliZIVsiBzJhHa"
 },
 {
  "id": "1H461TN1",
...
window.traLoiNgan11 = [
 ...
 {
  "id": "1D333TL2",
  "question": "Tìm giá trị của tham số $m$ để hàm số $f(x)=\\left\\{\\begin{array}{ll}\\dfrac{x^2-x-2}{x-2} &, \\text { khi } x \\neq 2\\\\m+1 &, \\text { khi } x=2\\end{array}\\right.$ liên tục tại điểm $x_0=2$.",
  "answer": "2",
  "explain": "Ta có $f(2)=m+1$ và $\\displaystyle\\lim\\limits _{x \\rightarrow 2}f(x)=\\displaystyle\\lim\\limits _{x \\rightarrow 2} \\dfrac{x^2-x-2}{x-2}=\\displaystyle\\lim\\limits _{x \\rightarrow 2} \\dfrac{(x-2)(x+1)}{x-2}=\\displaystyle\\lim\\limits _{x \\rightarrow 2} (x+1)=3$<br>Để hàm số liên tục tại điểm $x_0=2$ thì $\\displaystyle\\lim\\limits _{x \\rightarrow 2} f(x)=f(2) \\Leftrightarrow m+1=3 \\Leftrightarrow m=2$",
  "_wm": "PkFu6GNaZLw9sAMliZIVsiBzJhHa"
 },
 {
  "id": "1D333TL3",
  "question": "Cho hàm số $f(x) =\\left\\{\\begin{array}{ll}x^2 + x + 1, & \\text{khi } x \\neq 4\\\\2a + 1, & \\text{khi } x = 4\\end{array}\\right..$ Tìm $a$ để hàm số liên tục tại $x_0 = 4$.",
  "answer": "10",
  "explain": "Ta có <br>• $f(x_0) = f(4) = 2a + 1.$<br>• $\\lim\\limits_{x \\to x_0} f(x) = \\lim\\limits_{x \\to 4} \\left( x^2 + x + 1 \\right) = 21.$ Để hàm số liên tục tại điểm $x_0 = 4$ thì $\\lim\\limits_{x \\to 4} f(x) = f(4)\t\\Rightarrow 2a + 1 = 21 \\Leftrightarrow a = 10.$",
  "_wm": "PkFu6GNaZLw9sAMliZIVsiBzJhHa"
 },
 ...
 {
  "id": "1H421TL1",
  "question": "Trong không gian, cho hai đường thẳng phân biệt, có bao nhiêu vị trí tương đối giữa hai đường thẳng đó?",
  "answer": "4",
  "explain": "Trong không gian, hai đường thẳng phân biệt có bốn vị trí tương đối đó là cắt nhau, song song, trùng nhau và chéo nhau.",
  "_wm": "PkFu6GNaZLw9sAMliZIVsiBzJhHa"
 },
 {
  "id": "1H432TL1",
 ...
 },
 {
  ...
  "question": "Cho tứ diện $ABCD$ có $M$, $N$ lần lượt là trung điểm của $AB$, $CD$; $P$ là điểm thuộc cạnh $AC$ sao cho $AP=2PC$. Gọi $S_{MNP}=2$ là diện tích tam giác $MNP$ và $S_{td}$ là diện tích thiết diện của tứ diện cắt bởi $(MNP)$. Tỉ số $\\dfrac{S_{MNP}}{S_{td}}$ bằng bao nhiêu?",
  "answer": "\\dfrac{1}{2}",
  "explain": "<img src=\"data/11/1H4/im1H43/1H43_tikz_006.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\"> Trong mặt phẳng $(ACD)$, $PN \\cap AD = I$.<br>Trong mặt phẳng $(ABD)$, $MI \\cap BD = Q$.<br>Lấy điểm $H \\in CD$ sao cho $PH \\parallel AD$.<br>Lấy điểm $K \\in BD$ sao cho $MK \\parallel AD$<br>Xét $\\triangle CAD$ có $PH\\parallel AD$ <br>$\\dfrac{PC}{CA}= \\dfrac{PH}{AD}$ (định lý Thales) \\quad <strong>(1)</strong><br>Xét $\\triangle NHP$ và $\\triangle NDI$ có $PH\\parallel ID$<br>$\\dfrac{NI}{NP}= \\dfrac{ID}{PH}$ (định lý Thales) \\quad <strong>(2)</strong><br>Từ <strong>(1)</strong> và <strong>(2)</strong> suy ra $\\dfrac{IN}{NP}\\cdot\\dfrac{PC}{CA}\\cdot\\dfrac{AD}{DI}=1 \\Leftrightarrow \\dfrac{IN}{NP}=3\\Rightarrow \\dfrac{NP}{IP}=\\dfrac{1}{4}$ và $\\dfrac{IN}{IP}=\\dfrac{3}{4}$<br><br>Xét $ \\triangle ABD$ có $MK\\parallel AD$<br>$\\dfrac{BM}{BA} = \\dfrac{MK}{AD}$ (định lý Thales) \\quad <strong>(3)</strong><br>Xét $\\triangle MKQ$ và $\\triangle QDI$ có $MK \\parallel DI$<br>$\\dfrac{IQ}{MQ}=\\dfrac{DI}{MK}$ (định lý Thales) \\quad <strong>(4)</strong><br>Từ <strong>(3)</strong> và <strong>(4)</strong> suy ra $\\dfrac{IQ}{QM}\\cdot\\dfrac{MB}{AB}\\cdot\\dfrac{AD}{DI}=1 \\Leftrightarrow \\dfrac{IQ}{QM}=2\\Rightarrow \\dfrac{IQ}{IM}=\\dfrac{2}{3}$<br>Ta có $\\dfrac{S_{MNP}}{S_{MIP}}=\\dfrac{NP}{IP}=\\dfrac{1}{4}$ <br>Lại có $\\dfrac{S_{INQ}}{S_{IPM}}=\\dfrac{IN}{IP}\\cdot\\dfrac{IQ}{IM}=\\dfrac{3}{4}\\cdot\\dfrac{2}{3}= \\dfrac{1}{2} \\Rightarrow \\dfrac{S_{td}}{S_{MIP}}= \\dfrac{1}{2}$ <br>Vậy $\\dfrac{S_{MNP}}{S_td}=\\dfrac{1}{2}$.",
  "_wm": "PkFu6GNaZLw9sAMliZIVsiBzJhHa"
 },
 {
  "id": "1H435TL2",
  "question": "Cho hình chóp $S.ABCD$ có đáy là hình bình hành $ABCD$, $O$ là giao điểm của $AC$ và $BD$. Tam giác $SCD$ là tam giác đều cạnh $2$. Mặt phẳng $(P)$ đi qua $O$ và song song với mặt phẳng $(SCD)$. Tính diện tích thiết diện tạo bởi mặt phẳng $(P)$ và các mặt của hình chóp $S.ABCD$ (làm tròn đến hàng phần mười).",
  "answer": "1,3",
  "explain": "<img src=\"data/11/1H4/im1H43/1H43_tikz_012.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\"><br>Trong $(ABCD)$ lấy $M$, $N$ lần lượt là trung điểm $BC$, $AD$<br>$\\Rightarrow \\left\\{\\begin{array}{l}M, O, N \\text{ thẳng hàng}\\\\MN \\text{ là đường trung bình của hình bình hành }ABCD\\end{array}\\right. \\Rightarrow \\left\\{\\begin{array}{l}MN \\parallel AB \\parallel CD\\\\MN = AB = CD = 2\\end{array}\\right.$<br>Xét $(SAD)$: $NP \\parallel SD$ với $P \\in SA$<br>Xét $(SAB)$: $PQ \\parallel AB$ với $Q \\in SB$<br>$\\Rightarrow PQ \\parallel CD$<br>Ta có: $\\left\\{\\begin{array}{l}PQ, PN \\in (MNPQ)\\\\PQ \\cap PN = {P}\\\\PQ \\parallel (SCD)\\\\PN \\parallel (SCD)\\end{array}\\right. \\Rightarrow (P) \\equiv (MNPQ)$<br>Ta có: $\\left\\{\\begin{array}{l}MN \\parallel AB\\\\PQ \\parallel AB\\end{array}\\right. \\Rightarrow PQ \\parallel MN \\Rightarrow MNPQ \\text{ là hình thang}$<br>Xét $\\triangle SAD$ có $NP \\parallel SD$, $N$ là trung điểm $AD$<br>$\\Rightarrow NP$ là đường trung bình của $\\triangle SAD$<br>$\\Rightarrow \\left\\{\\begin{array}{l}P \\text{ là trung điểm } SA\\\\NP = \\dfrac{1}{2}SD = 1\\end{array}\\right.$<br>Xét $\\triangle SAB$ có $PQ \\parallel AB$, $P$ là trung điểm $SA$<br>$\\Rightarrow PQ$ là đường trung bình của $\\triangle SAB$<br>$\\Rightarrow \\left\\{\\begin{array}{l}Q \\text{ là trung điểm } SB\\\\PQ = \\dfrac{1}{2}AB= \\dfrac{1}{2}CD = 1\\end{array}\\right.$<br>Xét $\\triangle SBC$ có $M$, $Q$ lần lượt là trung điểm của $BC$, $SB$<br>$\\Rightarrow MQ$ là đường trung bình của $\\triangle SBC$<br>$\\Rightarrow MQ = \\dfrac{1}{2}SC = 1$<br>Xét hình thang $MNPQ$ có $PQ &lt; MN$, $MQ = NP$<br>$\\Rightarrow MNPQ$ là hình thang cân<br>Trong $(MNPQ)$, kẻ $QH \\perp MN$ ($H \\in MN$), $PK \\perp MN$ ($K \\in MN$)<br>Ta có: $\\left\\{\\begin{array}{l}PQ = HK = 1\\\\MN = 2\\end{array}\\right. \\Rightarrow MH = \\dfrac{1}{2}$ Xét $\\triangle QHM$ vuông tại $H$ theo Pythagore, ta có:<br>$QH^2 + MH^2 = MQ^2<br>\\Leftrightarrow QH^2 + \\left(\\dfrac{1}{2}\\right)^2 = 1^2<br>\\Leftrightarrow QH = \\dfrac{\\sqrt{3}}{2}$<br>$S_{MNPQ} = \\dfrac{PQ + MN}{2} \\cdot QH = \\dfrac{1 + 2}{2} \\cdot \\dfrac{\\sqrt{3}}{2} = \\dfrac{3\\sqrt{3}}{4} \\approx 1{,}3$",
  "_wm": "PkFu6GNaZLw9sAMliZIVsiBzJhHa"
 },
 {
  "id": "1H442TL1",
